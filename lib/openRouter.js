...
/** Модели в OpenRouter (provider/model).
 *  Gemini-3 preview модели больше недоступны в OpenRouter (404), поэтому
 *  PRO_3 и FLASH_3 указывают на gemini-2.5. Именa ключей оставлены прежними,
 *  чтобы не ломать api/script.js, api/scriptwriter.js и др.
 */
export const MODELS = {
  FLASH: 'google/gemini-2.5-flash',
  FLASH_3: 'google/gemini-2.5-flash',
  PRO_3: 'google/gemini-2.5-pro',
  CLAUDE_SONNET_35: 'anthropic/claude-sonnet-4.5',
};
